...
public class TC_001_ElectricityTest extends DriverTestCase {
	...
	@Test
	public void TC_001_ElectricityTestMethod() throws InterruptedException, IOException {
		...
		//select the electricity option
		energyPage.clickOnElectricityIcon();
		
		//select the gas supplier
		energyPage.selectBritishGasSupplierForElectricity();
		...
		// energyPage.enterElectricityUsage("100", "50");
		 energyPage.enterGasAndElectricityUsage("100");
		...
		energyPage= energyPage.selectQuarterlyPayMethod();
